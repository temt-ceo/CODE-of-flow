export default {
    createPlayer: `
      ...
      transaction(nickname: String) {
        prepare(acct: AuthAccount) {
          // Step1
          acct.save(<- CodeOfFlowBeta3.createPlayer(nickname: nickname), to: CodeOfFlowBeta3.PlayerStoragePath)
          // Step2
          acct.link<&CodeOfFlowBeta3.Player{CodeOfFlowBeta3.IPlayerPublic}>(CodeOfFlowBeta3.PlayerPublicPath, target: CodeOfFlowBeta3.PlayerStoragePath)
          }
        execute {
          log("success")
        }
    ...
    matchingStart: `
      ...
      transaction() {
        prepare(acct: AuthAccount) {
          let gamePlayer = acct.borrow<&CodeOfFlowBeta3.Player>(from: CodeOfFlowBeta3.PlayerStoragePath)
